...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  // Internal open state; controllable via `open`/`onOpenChange`.
  ...
  // Restore the persisted open/collapsed state after mount (client-only, so no
  // hydration mismatch). Only applies when the provider is uncontrolled.
  React.useEffect(() => {
...
>(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-side={side}
    >
      {/* Spacer that reserves the sidebar width and animates on collapse. */}
      <div
        className={cn(
  ...
  ({ className, ...props }, ref) => (
    <main
      ...
      className={cn(
        ...
        'peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-soft',
        className,
      )}
      {...props}
    />
