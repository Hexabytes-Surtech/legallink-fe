...
import { USE_MOCK, mockDelay, MOCK_MATTER } from '@/lib/mock-data';

type AnalysisStep = 1 | 2 | 3;

const STEP_LABELS = {
  en: [
    'Classifying your matter...',
    'Retrieving relevant laws & judgments...',
    'Generating your legal summary...',
  ],
  bn: [
    'আপনার বিষয় শ্রেণীবদ্ধ করা হচ্ছে...',
    'প্রাসঙ্গিক আইন ও রায় খোঁজা হচ্ছে...',
    'আপনার আইনি সারসংক্ষেপ তৈরি হচ্ছে...',
  ],
};
...
export default function IntakePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (USE_MOCK) {
        // Simulate the 3 AI pipeline steps
        setAnalysisStep(1);
        ...
        setAnalysisStep(3);
        await mockDelay(800);
        router.push(`/app/matter/${MOCK_MATTER.id}`);
        return;
      }
      ...
      router.push(`/app/matter/${res.data.id}`);
    } catch (err) {
        ...
        <div style={{ width: '100%', maxWidth: '700px', margin: '0 auto' }}>
          ...
          <div className="card" style={{ padding: '2.5rem', animation: 'slideInUp 0.5s ease 0.1s both' }}>
            ...
            <div style={{
              ...
              <span style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--color-gray-500)' }}>
                {t('intake.language.label')}
              </span>
                  ...
                  {steps.map((step, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{ width: '1.75rem', height: '1.75rem', flexShrink: 0 }}>
                        {analysisStep > i + 1 ? (
                          <svg viewBox="0 0 24 24" fill="#10B981" width="100%" height="100%">
                      ...
                      <span style={{
                        fontSize: '0.9375rem',
                        fontWeight: analysisStep === i + 1 ? 600 : 400,
                        color: analysisStep > i + 1
                          ? '#059669'
                          : analysisStep === i + 1
                          ? '#0D1B2A'
                          : '#9CA3AF',
              ...
              <form onSubmit={handleSubmit}>
                <div style={{ position: 'relative', marginBottom: '1.5rem' }}>
                  ...
                  <div style={{
                    ...
                    right: '0.875rem',
                    fontSize: '0.75rem',
                    color: query.length > MAX_CHARS * 0.9 ? '#F59E0B' : 'var(--color-gray-300)',
                    background: 'white',
                    padding: '0 4px',
                  }}>
                ...
                <button
                  ...
                  style={{ width: '100%', padding: '0.9375rem', fontSize: '1.0625rem', fontFamily: language === 'bn' ? 'var(--font-bangla)' : 'inherit' }}
                  disabled={!query.trim()}
                >
                  {t('intake.submit')}
          ...
          <p style={{
            ...
            {language === 'en'
              ? '🔒 Anonymous by default. No sign-up required. Your data expires in 24 hours.'
              : '🔒 ডিফল্টভাবে বেনামে। কোনো সাইন আপ দরকার নেই। আপনার ডেটা ২৪ ঘণ্টায় মুছে যায়।'}
          </p>
        </div>
      </main>
    </div>
